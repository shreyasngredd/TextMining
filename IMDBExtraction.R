...
aurl <- "https://www.imdb.com/title/tt5970844/reviews?ref_="
imdb_speech <- NULL
...
write.table(imdb_speech,"ToH_reviews.txt")
...
x = readLines(file.choose()) 	# Choose the .txt file where the data is stored
