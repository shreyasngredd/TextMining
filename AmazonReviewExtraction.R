#####TEXT MINING- ECOMMERCE REVIEW EXTRACTION#####
...
aurl <- "https://www.amazon.in/Honor-6X-Grey-32GB/product-reviews/B01FM7JGT6/ref=cm_cr_arp_d_paging_btm_3?showViewpoints=1&pageNumber=1"
amazon_reviews <- NULL
for (i in 1:30){
...
write.table(amazon_reviews,"Honor.txt")
