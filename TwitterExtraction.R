...
cred <- OAuthFactory$new(consumerKey='3mLG4NmZTmCwZZ8R21JUG9m2F', # Consumer Key (API Key)
                         consumerSecret='QCyGAIQkBiz3Gdl3QcKdnXoQXldr5XsYBeFgl0dXHqAJpQgZIy', #Consumer Secret (API Secret)
...
#Saving keys for future purpose
save(cred, file="twitter authentication.Rdata")

load("twitter authentication.Rdata")

setup_twitter_oauth("3mLG4NmZTmCwZZ8R21JUG9m2F", # Consumer Key (API Key)
                    "QCyGAIQkBiz3Gdl3QcKdnXoQXldr5XsYBeFgl0dXHqAJpQgZIy", #Consumer Secret (API Secret)
                    "1064203698937556992-RKKRDfMpYETZF2lmpDkjS5sElAc0K3",  # Access Token
                    "unFZvZc2zZXfNiIZsEFhpAk6lm0Uqr2OjKpmnJ8kBKGY5")  #Access Token Secret


Tweets <- userTimeline('KTRTRS', n = 1000)

TweetsDF <- twListToDF(Tweets)
View(TweetsDF)

#Saving in .csv file
write.csv(TweetsDF, "Tweets_KTR.csv")
...
x = readLines(file.choose()) #Choose the excel file
